...
class TestDataProductIdentifier:
    ...
    def test_enum_member_names(self):
        ...
        expected_names = [
            ...
            "l1a_icie_nom_hk_lwc_330k_trimmed",
            ...
            "l1a_icie_nom_hk_viirs_lunar_pos_start_trimmed",
            "l1a_icie_nom_hk_viirs_lunar_neg_start_trimmed",
            ...
            "cal_solar_lw_ter",
            "cal_solar_sw_ter",
            "cal_lunar_south_pole",
            "cal_lunar_north_pole",
            "cal_ct_video_6min",
            "cal_ct_video_12min",
            "cal_ct_video_18min",
            "cal_raps_video_6min",
    ...
    def test_calibration_event_products_metadata(self):
        ...
        expected_products = {
            ...
            DataProductIdentifier.cal_lwc_310k: "LWC-310K",
            DataProductIdentifier.cal_lwc_320k: "LWC-320K",
            DataProductIdentifier.cal_lwc_330k: "LWC-330K",
