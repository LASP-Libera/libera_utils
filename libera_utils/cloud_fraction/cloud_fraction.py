...
from libera_utils.footprint_matching.product import build_camtime_grid, build_camtime_provenance
...
def generate_placeholder_cloud_fraction_camtime(
    ...
    *,
    ...
    # Scatter the flat per-footprint placeholder columns onto the same grid; padded cells take NaN
    # (matching how FMATCH pads its float32 camera-timescale variables).
