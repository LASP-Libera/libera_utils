...
class DataProductIdentifier(StrEnum):
    ...
    l1a_icie_nom_hk_lwc_330k_trimmed = ("NOM-HK-LWC-330K-TRIMMED", DataLevel.L1A)
    ...
    l1a_icie_nom_hk_viirs_lunar_pos_start_trimmed = ("NOM-HK-VIIRS-LUNAR-POS-START-TRIMMED", DataLevel.L1A)
    l1a_icie_nom_hk_viirs_lunar_neg_start_trimmed = ("NOM-HK-VIIRS-LUNAR-NEG-START-TRIMMED", DataLevel.L1A)
    ...
    cal_lwc_300k = ("LWC-300K", DataLevel.CAL)
    cal_lwc_305k = ("LWC-305K", DataLevel.CAL)
