...
COMMENT ON COLUMN sdp.cr.file_name IS 'Name of the associated PDS construction record.';
...
COMMENT ON COLUMN sdp.cr_apid.n_ssc_discontinuities IS '(24-6) Number of SSC discontinuities for this APID.';
