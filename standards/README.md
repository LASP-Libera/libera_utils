...
| Loop wall-clock exit  | **25 minutes**                                                                                          | Wrong, and kept only until the ratchet replaces it. It was set when three PR-lane runs looked like 3.5 minutes; at 357 s a run they are ~18, and the first recorded exit — PR #66, three reviewer rounds — took about 45 minutes. The suite is now a real bound, not a rounding error |
